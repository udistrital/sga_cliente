...
export const environment = {
  ...
  // TERCEROS_SERVICE: 'http://api.intranetoas.udistrital.edu.co:8121/v1/',
  PERSONA_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/personas_crud/v1/',
  // PERSONA_SERVICE: 'http://api.intranetoas.udistrital.edu.co:8083/v1',
  ...
  // PROYECTO_ACADEMICO_SERVICE: 'http://api.intranetoas.udistrital.edu.co:8116/v1/',
  ...
  // SGA_MID_SERVICE: 'http://api.intranetoas.udistrital.edu.co:8119/v1/',
  ...
  // INSCRIPCION_SERVICE: 'http://api2.intranetoas.udistrital.edu.co:8208/v1/',
