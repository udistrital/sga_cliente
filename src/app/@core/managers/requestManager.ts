...
export class RequestManager {
  ...
  post(endpoint, element) {
    return this.http.post<any>(`${this.path}${endpoint}`, element).pipe(
  ...
  put(endpoint, element) {
    return this.http.put<any>(`${this.path}${endpoint}/${element.Id}`, element).pipe(
      catchError(this.errManager.handleError),
    );
  }
   ...
   */
  delete(endpoint, id) {
    return this.http.delete<any>(`${this.path}${endpoint}/${id}`).pipe(
      catchError(this.errManager.handleError),
    );
  }
};
