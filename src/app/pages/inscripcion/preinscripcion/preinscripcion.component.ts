...
export class PreinscripcionComponent implements OnInit {
  ...
  setPercentage_total() {
    this.percentage_total = Math.round(this.utilidadesService.getSumArray(this.percentage_tab_info)) / 2;
    ...
    this.percentage_total += Math.round(this.utilidadesService.getSumArray(this.percentage_tab_proy)) / 4;
