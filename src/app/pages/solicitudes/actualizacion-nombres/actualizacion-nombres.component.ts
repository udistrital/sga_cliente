...
export class ActualizacionNombresComponent implements OnInit {
        ...
        (response: any) => {
          if (response.Response.Code === '200') {
            ...
            this.solicitudForm.campos[this.getIndexForm('FechaSolicitud')].valor =
              momentTimezone.tz(response.Response.Body[0].FechaSolicitud,
                                'America/Bogota').format('DD/MM/YYYY');
  ...
  enviarRespuesta(event) {
    ...
    this.solicitudRespuesta.Estado = this.respuestaSolicitudForm.campos[1].valor;
