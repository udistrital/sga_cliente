...
@Component({
  selector: 'ngx-historico-acreditaciones',
  templateUrl: './historico-acreditaciones.component.html',
  styleUrls: ['./historico-acreditaciones.component.scss'],
})
export class ReporteHistoricoAcreditacionesComponent implements OnInit {
  ...
  initReportConfig() {
    this.reportConfig = {
      documentLabel: 'registros_proyecto',
