...
@Component({
  selector: 'ngx-icfes-proyecto',
  templateUrl: './icfes-proyecto.component.html',
  styleUrls: ['./icfes-proyecto.component.scss'],
})
export class IcfesProyectoComponent implements OnInit {
