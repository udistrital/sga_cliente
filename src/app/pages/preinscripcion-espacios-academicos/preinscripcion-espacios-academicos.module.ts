...
import { EspaciosAcademicosRoutingModule, routedComponents } from './preinscripcion-espacios-academicos-routing.module';
...
export class PreinscripcionEspaciosAcademicosModule { }
