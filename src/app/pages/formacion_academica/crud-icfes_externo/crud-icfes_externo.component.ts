...
import { FORM_ICFES_EXTERNO} from './form-icfes_externo';
...
@Component({
  ...
  selector: 'ngx-crud-icfes_externo',
  templateUrl: './crud-icfes_externo.component.html',
  styleUrls: ['./crud-icfes_externo.component.scss'],
})
export class CrudIcfesExternoComponent implements OnInit {
  ...
  constructor(
    ...
    this.formInfoFormacionAcademica = FORM_ICFES_EXTERNO;
    this.construirForm();
