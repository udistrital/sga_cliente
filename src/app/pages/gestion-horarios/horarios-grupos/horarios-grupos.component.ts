...
@Component({
  selector: 'horarios-grupos',
  templateUrl: './horarios-grupos.component.html',
  styleUrls: ['./horarios-grupos.component.scss']
})
export class HorariosGruposComponent implements OnInit {
