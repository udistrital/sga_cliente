...
@Component({
  ...
  selector: 'ngx-crud-informacion-contacto_externa',
  templateUrl: './crud-informacion_contacto_externa.component.html',
  styleUrls: ['./crud-informacion_contacto_externa.component.scss'],
})
export class CrudInformacionContactoExternaComponent implements OnInit {
  ...
  constructor(
    ...
    this.formInformacionContacto = FORM_INFORMACION_CONTACTO_EXTERNA;
    this.construirForm();
