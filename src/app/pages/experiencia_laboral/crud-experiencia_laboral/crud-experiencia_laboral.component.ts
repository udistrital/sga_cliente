        ...
        .then((willDelete) => {
          if (willDelete.value) {
            ...
            if (this.info_experiencia_laboral.Experiencia.Soporte.file !== undefined) {
              files.push({
                nombre: this.userData.sub, key: 'Documento',
    ...
    this.sgaMidService.put('experiencia_laboral/', this.info_experiencia_laboral)
      .subscribe(res => {
        ...
        if (r !== null && r.Type !== 'error') {
          ...
          this.popUpManager.showInfoToast(this.translate.instant('GLOBAL.crear') +
  ...
  postExperianciaLaboral() {
    ...
    this.sgaMidService.post('experiencia_laboral/', this.info_experiencia_laboral)
      .subscribe(res => {
        ...
        if (r !== null && r.Type !== 'error') {
          this.eventChange.emit(true);
          this.popUpManager.showInfoToast(this.translate.instant('experiencia_laboral.experiencia_laboral_registrada'));
          this.info_experiencia_laboral_id = 0;
          this.info_experiencia_laboral = undefined;
          this.indexSelect = NaN;
          this.detalleExp = undefined;
          ...
          this.popUpManager.showErrorToast(this.translate.instant('experiencia_laboral.experiencia_laboral_no_registrada'));
        }
        this.loading = false;
      },
      (error: HttpErrorResponse) => {
